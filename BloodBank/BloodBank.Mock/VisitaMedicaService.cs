...
namespace BloodBank.Mock
{
    public class VisitaMedicaService : DataService<VisitaMedica>
    {
        ...
        internal static VisitaMedica V5 = new VisitaMedica(DonatoreService.D5, "Descrizione impercettibile", new DateTime(2016, 05, 15), Idoneità.Idoneo, MedicoService.M2, "Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur?");
        ...
        internal static VisitaMedica V7 = new VisitaMedica(DonatoreService.D7, "Descrizione breve", new DateTime(2015, 12, 09), Idoneità.NonIdoneo, MedicoService.M3, "Va tutto bene.");
        ...
        internal static VisitaMedica V10 = new VisitaMedica(DonatoreService.D10, "Descrizione superbreve", new DateTime(2016, 04, 13), Idoneità.NonIdoneo, MedicoService.M2, "Facciamo che torni un'altra volta.");
