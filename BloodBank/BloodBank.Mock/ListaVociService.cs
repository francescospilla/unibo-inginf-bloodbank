...
namespace BloodBank.Mock
{
    ...
    public class ListaVociAnalisiService : ListaVociService<Analisi>
    {
        ...
        internal static Analisi A1 = new Analisi(D1, "Descrizione 1", DateTime.Now.AddMinutes(-3), Lva1);
    ...
    public class ListaVociQuestionarioService : ListaVociService<Questionario>
    {
        ...
        internal static Questionario Q1 = new Questionario(D1, "Descrizione questionario 1", DateTime.Now.AddMinutes(-4), Lvq1);
