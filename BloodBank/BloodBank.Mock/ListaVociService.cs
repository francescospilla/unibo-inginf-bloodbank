...
{
    public abstract class ListaVociService<U> : DataService<U> where U : ListaVoci
    {
        protected ListaVociService(IList<U> items) : base(items)
        {
        }
    }
    ...
    public class ListaVociAnalisiService : ListaVociService<Analisi>
    {
        ...
        internal static Analisi A4 = new Analisi(D4, "Descrizione 4", new DateTime(2016, 08, 23), Lva4);

        private static readonly IList<Analisi> Items = new List<Analisi>()
        {
            A1, A2, A3, A4
        };
    ...
    public class ListaVociQuestionarioService : ListaVociService<Questionario>
    {
        ...
        internal static Questionario Q4 = new Questionario(D4, "Descrizione questionario 1", new DateTime(2016, 08, 23), Lvq4);
        internal static Questionario Q5 = new Questionario(D5, "Descrizione questionario 1", new DateTime(2016, 09, 14), Lvq5);

        private static readonly IList<Questionario> Items = new List<Questionario>()
        {
            Q1, Q2, Q3, Q4, Q5
        };
